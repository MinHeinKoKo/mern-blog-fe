...
import { AiOutlineTwitter , AiFillInstagram , AiFillLinkedin , AiFillHeart} from "react-icons/ai"
...
const Footer = () => {
  return (
    <section className='bg-dark-hard'>
      <footer className='container mx-auto grid grid-cols-10 px-5 py-10 gap-y-10 gap-x-5 md:pt-20 md:grid-cols-12 lg:grid-cols-10 lg:grid-x-10'>
        ...
        <div className='col-span-10 md:order-first lg:col-span-2 md:col-span-4'>
          <div className='flex items-center justify-center'>
          <img src={images.Logo} alt="" className='w-28 text-center md:mx-o' />
          <p className='font-montserrat text-gray-200 brightness-50 text-2xl font-semibold md:text-xl lg:text-lg'>M1n's Blog</p>
          </div>
          ...
          <ul className='flex justify-center items-center mt-5 space-x-4 text-gray-300 md:justify-start'>
            ...
            <li><a href="#"><AiFillLinkedin className='w-6 h-auto' /></a></li>
          </ul>
        </div>
